...
class ConsumerKycScreen extends StatefulWidget {
  ...
  _ConsumerKycScreenState createState() =>
      _ConsumerKycScreenState();
}

class _ConsumerKycScreenState extends State<ConsumerKycScreen> {
  ...
  void initState() {
    super.initState();
    _futureKYCDetails = APIService.getInstance(context).kycDetailsAPI.getKYCDetails();
  }
...
class _ProofSectionWidget extends StatefulWidget {
  final String title;
  ...
  @override
  State<_ProofSectionWidget> createState() => _ProofSectionWidgetState();
}

class _ProofSectionWidgetState extends State<_ProofSectionWidget> {
...
class _BankProofUploadSection extends StatefulWidget {
  ...
  @override
  State<_BankProofUploadSection> createState() => _BankProofUploadSectionState();
}

class _BankProofUploadSectionState extends State<_BankProofUploadSection> {
  String? selectedType;
  String? fileName;
  File? selectedFile;
