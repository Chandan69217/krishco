...
class ConsumerClaimScreen extends StatefulWidget {
  @override
  _ConsumerClaimScreenState createState() => _ConsumerClaimScreenState();
}

class _ConsumerClaimScreenState extends State<ConsumerClaimScreen> {
