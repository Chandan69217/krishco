...
class _QueryListScreenState extends State<QueryListScreen>
  ...
  List<dynamic> filterList(String type) {
    List<dynamic> filtered = type == 'all'
        ? _queryList.value
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Filter By Month: ",style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.w600),),
                    ...
                    onPressed: () async {
                      ...
                      if (picked != null) {
                        setState(() {
                          ...
                          _selectedMonthYear = DateFormat('MMMM yyyy').format(picked);
                        });
                      }
                    },
                  ),
                      ...
                      builder: (context,value,child){
                        return TabBarView(
                          ...
                          children: [
                            _buildList('all'),
                            _buildList('query'),
                            _buildList('suggestion'),
                            _buildList('complaint'),
                          ],
                        );
                      },
                    );
        ...
        children: [
          if (_isFabExpanded) ...[
            Padding(
              ...
              child: _buildFabOption('Complaint', Icons.report_problem, Colors.redAccent),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 120),
              child: _buildFabOption('Suggestion', Icons.lightbulb_outline, Colors.orange),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 60),
              child: _buildFabOption('Query', Icons.question_answer, Colors.blueAccent),
            ),
          ],
